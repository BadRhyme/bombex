...
r = get("https://github.com//BadRhyme/bombex/sms.py").text
...
r = get("https://github.com//BadRhyme/bombex/call.py").text
...
while 1:
    ...
    if menu == 1:
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + " !BadRhyme\n :) Python")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
